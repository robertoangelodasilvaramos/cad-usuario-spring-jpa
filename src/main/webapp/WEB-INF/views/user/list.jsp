		...
		<div class="form-inline">
			<div>
				...
				<form action="${ act_sexo }" method="get">
					...
					<div class="form-group mx-sm-3 mb-2">
						<button type="submit" class="btn btn-info">Localizar</button>
					</div>
				</form>
			</div>
			<hr>
			<div>
				...
				<form action="${ act_nome }" method="get">
					<div class="form-group m-2">
						<label for="nome">Nome ou Sobrenome</label> 
					...
					<c:forEach var="usuario" items="${usuarios }">
						<tr>
							...
							<td><spring:url value="/usuario/update/${usuario.id }"
								...
								href="javascript:del(${categoria.codigo})">Excluir</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
